...
#include "slalib.h"
#include "slamac.h"
void slaPlanet(double qfoo,int qbar,double qbaz[6],int*Q0)
...
slaPlanel(qfoo,1,qfoo,qcat,QFISH,qdog,Q5,QFRED,q16,q8,qbaz,&
...
0.0;QMUM[qfOBAz]=0.0;}for(qfoobaz=0;qfoobaz<(int)(sizeof q36
/sizeof q36[0]);qfoobaz++){qDAd=(double)(q36[qfoobaz].Q34);
q9=(double)(q36[qfoobaz].QBLAcK);Q10=(double)(q36[qfoobaz].
q4);Q11=qDAd*QBAD+q9*qBuG+Q10*qsilly;q12=(qDAd*Q27+q9*
qgoogle+Q10*QYahoO)*DD2R;Q13=sin(Q11);Q14=cos(Q11);for(
qfOBAz=0;qfOBAz<3;qfOBAz++){qdisk=q36[qfoobaz].Q35[qfOBAz].
q22;Q15=q36[qfoobaz].Q35[qfOBAz].Q33;QBUGGY[qfOBAz]=QBUGGY[
qfOBAz]+qdisk*Q13+Q15*Q14;QMUM[qfOBAz]=QMUM[qfOBAz]+(qdisk*
Q14-Q15*Q13)*q12;}}q16=(Q30+qtrick*QQUUX+QBUGGY[0])*DD2R;q17
=(qtrick+QMUM[0])*DD2R/q2;QEMPTY=(q31+QBUGGY[1])*DD2R;q18=
QMUM[1]*DD2R/q2;QFULL=Q32+QBUGGY[2];qfast=QMUM[2]/q2;qsmall=
sin(q16);QBIG=cos(q16);QOK=sin(QEMPTY);QHELLO=cos(QEMPTY);
QBYE=qsmall*QHELLO;QMAGIC=QBIG*QHELLO;q19=QFULL*QMAGIC;q20=
QFULL*QBYE;qobSCUrE=QFULL*QOK;QSPEED=qfast*QMAGIC-QFULL*(
QBIG*QOK*q18+QBYE*q17);qIndex=qfast*QBYE+QFULL*(-qsmall*QOK*
q18+QMAGIC*q17);Q21=qfast*QOK+QFULL*QHELLO*q18;qbaz[0]=q19;
qbaz[1]=q20*Q3-qobSCUrE*qfoobar;qbaz[2]=q20*qfoobar+qobSCUrE
*Q3;qbaz[3]=QSPEED;qbaz[4]=qIndex*Q3-Q21*qfoobar;qbaz[5]=
qIndex*qfoobar+Q21*Q3;}}
