...
class Test_radial_offset_file_numerical_values:
    ...
    @given(centre=st.tuples(st.floats(min_value=-1000.0, max_value=1000.0), st.floats(min_value=-1000.0, max_value=1000.0)), offset=st.floats(min_value=-1000, max_value=1000))
