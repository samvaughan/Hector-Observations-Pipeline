...
#include "slalib.h"
#include "slamac.h"
void slaEvp(double qfoo,double qbar,double qbaz[3],double Q0
...
Q27+qjoe*Q28;qtrick=slaEpj(qfoo);q31=DS2R*(0.035+(0.00085*(
...
[2]=Q30;if(q2!=0){slaPrec(qtrick,qbar,Q35);for(Q3=0;Q3<3;Q3
