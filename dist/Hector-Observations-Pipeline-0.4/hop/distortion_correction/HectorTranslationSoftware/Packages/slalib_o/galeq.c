...
#include "slalib.h"
#include "slamac.h"
void slaGaleq(double qfoo,double qbar,double*qbaz,double*Q0)
...
slaDcs2c(qfoo,qbar,qfobar);slaDimxv(q2,qfobar,q1);slaDcc2s(
q1,qbaz,Q0);*qbaz=slaDranrm(*qbaz);*Q0=slaDrange(*Q0);}
