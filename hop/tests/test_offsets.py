...
import numpy as np
import pandas as pd
from hexabundle_allocation.problem_operations import extract_data, file_arranging, offsets, hexabundle
...
def config():
    ...
    config = dict(
        fileNameHexa="tests/data/offsets/Hexas_tile_150_m22_guides_central_CONFIGURED_correct_header.csv",
        fileNameGuides="tests/data/offsets/Guides_tile_150_m22_guides_central_CONFIGURED_correct_header.csv",
        ...
        offsetFile="hexabundle_allocation/Hexa_final_prism_gluing_PQ_table.xlsx",
