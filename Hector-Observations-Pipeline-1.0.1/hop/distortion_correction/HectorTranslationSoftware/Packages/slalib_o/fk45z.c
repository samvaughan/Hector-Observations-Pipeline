...
#include "slalib.h"
#include "slamac.h"
void slaFk45z(double qfoo,double qbar,double qbaz,double*Q0,
...
{-0.435623,0.012254,0.002117}};slaDcs2c(qfoo,qbar,Q3);q1=(
...
][qfoobar]*qfOBAz[qfoobar];}qfoobaz[q2]=q1;}q1=(slaEpj(
slaEpb2d(qbaz))-2000.0)/QQUUX;for(q2=0;q2<3;q2++){qfoobaz[q2
]+=q1*qfoobaz[q2+3];}slaDcc2s(qfoobaz,&q1,qfobar);*Q0=
slaDranrm(q1);}
